...
public class Driver extends AbstractScriptellaDriver {
    static final DialectIdentifier DIALECT = new DialectIdentifier(getScriptellaTitle(), getScriptellaVersion());

    public Connection connect(ConnectionParameters connectionParameters) {
        return new ScriptellaConnection(connectionParameters);
    }
