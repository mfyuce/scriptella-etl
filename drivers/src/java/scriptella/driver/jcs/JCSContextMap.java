...
/**
 * Mutable {@link JexlContext} implementation for
 ...
 * @version 1.1
 */
public final class JCSContextMap implements JexlContext {
     ...
     */
    public JCSContextMap(ParametersCallbackMap parametersMap) {
     ...
     */
    public JCSContextMap(ParametersCallback parentParameters, QueryCallback queryCallback) {
